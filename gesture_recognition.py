...
classifier = tf.estimator.Estimator(model_dir="/Users/skyler97/Desktop/Handsigning/tmp/cnn_model3", model_fn=cnn_model_fn)
prediction = None
...
def recognize():
	...
	while True:
		...
		thresh = cv2.threshold(blur,0,x,cv2.THRESH_BINARY+cv2.THRESH_OTSU)[1]
